...
<body>
	...
	<div class="all-contain">
		...
		<form>
			...
			<div class="btn-div">
			<button type="submit" class="btn btn-outline-secondary" id="submit-btn">수정</button>
			<button type="button" class="btn btn-outline-danger" id="submit-btn" onclick="location.href='/board/list'">취소</button>
			</div>
		</form>
